...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-04-2022 a las 21:48:36
...
(19, 'KVT47V', 'Cefora', 'Armas', '$$%$$%%$%%%$$%%$%$$$$%%%$$$/%%$$%$$$%%$$%%$$%%$$$$$$%%%', '04147721353', 0),
(13, 'KOWP145', 'Erwin', 'Armas', '$$%$$%%$%%%$$%%%$$$$$%%%$$$/%%%$$%$$%%$%%$$$%%$$$$$$%%$', '04160360067', 0),
...
(20, 'OGA1703', 'Josmar', 'Rodriguez', '$%%%$$$$$%%$%$$$$%%%$$$$$%%%$$$/%%$$%$$$%%$%%$$$%%$$%%$$%%%$$%$', '04120225089', 0),
...
(10, '$$$$$$$$$$', 'Anairo', 'Libertador con 37', '$$$$$$$$$$$$', 1),
(5, '$$$$$$$$$$', 'Eljergua', '42 con 13', '$$$$$$$$$$$$', 1),
...
(9, 'E-9601788 ', 'Prueba', 'Prueba', '02145785551', 1);
...
(7, '0101', 'admin', 'admin', 'admin', '%$%$%%$%$$%$%%$%%%$/%%$$$$%$%%$$%$$$%%$%', 'Administrador', 0, '', '2022-04-29 20:06:43'),
(10, '10847107', 'usuariog', 'usuario', 'usuario', '$%%$$%%$$%%$%$$/%%$$$%$$%%$$%$$', 'UsuarioEstandar', 1, '', '2022-04-17 19:02:46'),
(19, '26561631', 'usuario', 'Ramirez', 'Armas', '0000', 'Root', 1, '', '2022-04-29 20:06:10'),
(15, '26561633', 'eliasA', 'Elias', 'Banderas', '1234', 'Administrador', 1, '', '2022-04-17 19:02:52'),
...
--
ALTER TABLE `bitacora`
  MODIFY `id_bitacora` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=301;
